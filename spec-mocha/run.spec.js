...
describe('Integration Test', () => {
    ...
    describe('when sailor is being invoked for message processing', () => {
        ...
        it('should run trigger successfully on a huge message', (done) => {
            ...
            nock('https://api.acme.com')
                .post('/subscribe')
                .reply(200, { id: 'subscription_12345' })
                .get('/customers')
                .reply(200, customers);
            ...
            amqpHelper.on('data', ({ properties, body }, queueName) => {
                ...
                expect(body.originalMsg.headers).to.deep.equal({});
                expect(body.customers).to.deep.equal(customers);
                expect(body.subscription).to.deep.equal({
                    id: 'subscription_12345',
                    cfg: {
                        apiKey: 'secret'
                    }
