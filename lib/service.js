...
function processService(serviceMethod){
    ...
    var POST_RESULT_URL = settings.get('POST_RESULT_URL');
    var CFG = settings.get('CFG');
    var ACTION_OR_TRIGGER = settings.get('ACTION_OR_TRIGGER');
    var GET_MODEL_METHOD = settings.get('GET_MODEL_METHOD');
    var COMPONENT_PATH = settings.get('COMPONENT_PATH');
    var API_URI = settings.get('API_URI');
    var API_USERNAME = settings.get('API_USERNAME');
