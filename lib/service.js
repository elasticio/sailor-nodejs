...
function processService(serviceMethod){
    ...
    var POST_RESULT_URL = env.get('POST_RESULT_URL');
    var CFG = env.get('CFG');
    var ACTION_OR_TRIGGER = env.get('ACTION_OR_TRIGGER');
    var GET_MODEL_METHOD = env.get('GET_MODEL_METHOD');
    var COMPONENT_PATH = env.get('COMPONENT_PATH');
    var API_URI = env.get('API_URI');
    var API_USERNAME = env.get('API_USERNAME');
