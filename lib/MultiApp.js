...
class MultiApp extends App {
    ...
    async _restoreExecContext(flowId, stepId, msg) {
        ...
        manadatoryValues.DATA_ROUTING_KEY = `${manadatoryValues.WORKSPACE_ID}.${manadatoryValues.FLOW_ID}/${flowType}.`
            + `${manadatoryValues.STEP_ID}.message${suffix}`;
        manadatoryValues.ERROR_ROUTING_KEY = `${manadatoryValues.WORKSPACE_ID}.${manadatoryValues.FLOW_ID}/${flowType}.`
