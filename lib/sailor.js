...
class Sailor {
    ...
    readIncomingMessageHeaders(message) {
        ...
        assert(headers.stepId, 'StepId is missing in message header');
        ...
        function processMessageWithModule(module) {
            ...
            async function onData(data) {
                ...
                if (stepData.is_passthrough === true) {
                    const passthrough = Object.assign({}, _.omit(payload, 'passthrough'));

                    data.passthrough = Object.assign({}, origPassthrough, {
                        [incomingMessageHeaders.stepId]: passthrough
                    });
                }
