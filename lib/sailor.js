...
class Sailor {
    ...
    processMessage(payload, message) {
        ...
        const messageObjectId = message.properties.headers.objectId;
        ...
        function processMessageWithModule(module) {
            ...
            async function onError(err) {
                ...
                headers.end = new Date().getTime();
                const props = createAmqpProperties(headers);
                props[Symbol.for('objectId')] = messageObjectId;
        ...
        function onModuleNotFound(err) {
            ...
            outgoingMessageHeaders[Symbol.for('objectId')] = messageObjectId;
