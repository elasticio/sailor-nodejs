...
class Sailor {
    ...
    async processMessage(payload, message) {
        ...
        if (messageId) {
            ...
            if (alreadyExists) {
                logger.warn({ messageId }, `Duplicate message detected. This delivery will be ignored; the handler that first received this message will process it as part of deduplication.`);
