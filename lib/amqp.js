...
class Amqp {
    ...
    async sendError(err, properties, originalMessageContent, throttle) {
        ...
        await this.sendToExchange(settings.PUBLISH_MESSAGES_TO, settings.ERROR_ROUTING_KEY,
    ...
    async sendSnapshot(data, properties, throttle) {
        ...
        await this.sendToExchange(exchange, routingKey, payload, properties, throttle);
    }
}
