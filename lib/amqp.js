...
class Amqp {
    constructor(settings) {
        ...
        this.sendData = pThrottle(this.sendDataUnlimited, this.settings.DATA_RATE_LIMIT, 1000);
        this.sendError = pThrottle(this.sendErrorUnlimited, this.settings.ERROR_RATE_LIMIT, 1000);
        this.sendSnapshot = pThrottle(this.sendSnapshotUnlimited, this.settings.SNAPSHOT_RATE_LIMIT, 1000);
    }
