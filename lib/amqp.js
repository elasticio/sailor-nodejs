...
AMQPConnection.prototype.sendData = function sendData(data, headers) {
    ...
    var headerNamesToLowerCase = (result, value, key) => {
        result[key.toLowerCase()] = value;
    };
    msgHeaders = _.transform(msgHeaders, headerNamesToLowerCase, {});

    var routingKey = msgHeaders[HEADER_ROUTING_KEY] || settings.DATA_ROUTING_KEY;
