...
class Amqp {
    ...
    async decryptMessage(message) {
        ...
        if (maesterId) {
            ...
            content = (await request.get(`${this.settings.MAESTER_BASEPATH}/objects/${maesterId}`, options)).body;
        }
    ...
    async encryptMessage(data, properties) {
        ...
        s.push(null);
        await s.pipe(request.put(`${this.settings.MAESTER_BASEPATH}/objects/${maesterId}`, options));
