...
class TaskExec extends EventEmitter {
    ...
    async process(triggerOrAction, payload, cfg, snapshot) {
        try {
            ...
            // FIXME document this crazy logic
            ...
            // 3. if trigger or action returns non empty promise, then data event hsould be emitted
            if (possiblyPromise) {
...
// TODO hell knowns what that shit below is
// hope it's possible to remove it
