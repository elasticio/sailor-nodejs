describe('Component reader', () => {
    var ComponentReader = require('../src/component_reader.js').ComponentReader;

    it('Should find component located on the path', () => {
        var reader = new ComponentReader();
        var promise = reader.init('/spec-jasmine/component/');
    ...
    it('Should find component trigger', () => {
        ...
        var filename;
        var error;
        reader.init('/spec-jasmine/component/').then(() => {
            try {
