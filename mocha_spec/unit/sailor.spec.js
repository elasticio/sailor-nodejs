...
describe('Sailor', () => {
    ...
    describe('processMessage', () => {
        ...
        it('should catch all data calls and all error calls', async function test() {
            /**
             * Notice for everybody: that's REALLY BAD test.
             * It actually checks ACKNOWLEDGE TIMEOUT mechanism,
             * and it works only due to this mechanism.
             * In abscence of it this test fails.
             * Same happens if timeout for test is less then ACKNOWLEDGE timeout,
             * as mocha timeout gives no chance do do it's work
             * So change mocha timeout, that everything works.
             * TODO: datas_and_errors component should be rewritten
             * to emit end, instead of this shit.
             * Acknowledge timeout should be checked explicitly in separate test
             */
            this.timeout(envVars.ELASTICIO_TIMEOUT + 1000); // eslint-disable-line
